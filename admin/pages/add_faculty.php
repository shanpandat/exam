            ...
            <div class="content">
                <div class="report">
                    ...
                    <form method="post" action="" class="forms">
                        ...
                        <span class="name">Faculty Username</span> 
                        <input type="text" name="faculty_Username" placeholder="Faculty Username" required="true" /> <br />

                        <span class="name">Password</span> 
                        <input type="text" name="faculty_Password" placeholder="Password" required="true" /> <br />
                        ...
                        <input type="number" name="total_math_qns" placeholder="Total Number of Maths Questions" /><br />
                    ...
                    <?php 
                        if(isset($_POST['submit']))
                        {
                            ...
                            $faculty_username=$obj->sanitize($conn,$_POST['faculty_Username']);
                            $faculty_Password=$obj->sanitize($conn,$_POST['faculty_Password']);
                            ...
                            $where="username='$faculty_username'";
