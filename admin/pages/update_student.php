            ...
            <div class="content">
                <div class="report">
                    ...
                    <form method="post" action="" class="forms" enctype="multipart/form-data">
                        ...
                        <input type="email" name="email" readonly value="<?php echo $email; ?>" required="true" /><br />
                        
                        <span class="name">Username</span>
                        <input type="text" name="Username" readonly value="<?php echo $Username; ?>" required="true" /><br />
