            ...
            <div class="content">
                <div class="report">
                    ...
                    <form method="post" action="" class="forms">
                        ...
                        <input type="text" name="faculty_Username" readonly value="<?php echo $username; ?>" required="true" /> <br />

                        <span class="name">Password</span> 
                        <input type="text" name="faculty_Password" value="<?php echo $password; ?>" required="true" /> <br />
